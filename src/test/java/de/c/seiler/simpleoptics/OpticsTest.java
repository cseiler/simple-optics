...
public class OpticsTest {
	...
	public void test() {
		...
		Lens<Car, Color> Col = new Lens<>(Car::getColor, (c, col) -> {
			c.setColor(col);
			return c;
		});
		...
		Lens<Car, Seats> Seats = new Lens<>(Car::getSeats, (c, s) -> {
			c.setSeats(s);
			return c;
		});
		...
		OptionalLens<Car, Color> oCol = new OptionalLens<>(new Lens<>(Car::getColor, (c, cl) -> {
			c.setColor(cl);
			return c;
		}));
